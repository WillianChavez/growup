...
export function TypingAnimation({
  ...
  // Use predefined motion components to avoid creating components during render
  if (typeof Component === 'string' && Component === 'span') {
    return (
      <motion.span ref={elementRef} {...commonProps}>
        {content}
      </motion.span>
    );
  }
  if (typeof Component === 'string' && Component === 'div') {
    return (
      <motion.div ref={elementRef as React.Ref<HTMLDivElement>} {...commonProps}>
        {content}
      </motion.div>
    );
  }
  if (typeof Component === 'string' && Component === 'p') {
    return (
      <motion.p ref={elementRef as React.Ref<HTMLParagraphElement>} {...commonProps}>
        {content}
      </motion.p>
    );
  }
